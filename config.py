...
API_URL = getenv("API_URL", 'https://dodge-connections-guam-being.trycloudflare.com/search?q=arjit&key=gAnA42hI2e76M8kCWIsjf_cRwjo') #youtube song url
API_KEY = getenv("API_KEY", None) # youtube song api key, generate free key or buy paid plan from panel.thequickearn.xyz

UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/fessstygee/Sparrow",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/dev_Learntop") 
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/dev_Learntop")
